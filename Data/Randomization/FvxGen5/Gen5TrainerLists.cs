...
{
    /// <summary>
    /// Trainer index lists from UPR-FVX <c>com.uprfvx.romio.constants.Gen5Constants</c> (US ROMs).
    /// Indices are <b>1-based</b> trainer numbers as used by UPR (<c>trainer.index</c>).
    /// </summary>
    internal static class Gen5TrainerLists
    {
        static HashSet<int> BuildSet(int[] raw)
        {
        ...
        /// <summary>Source: UPR-FVX Gen5Constants.bw1MainPlaythroughTrainers.</summary>
        static readonly int[] Bw1MainPlaythroughRaw =
        {
        ...
        /// <summary>Source: UPR-FVX Gen5Constants.bw2MainPlaythroughTrainers.</summary>
        static readonly int[] Bw2MainPlaythroughRaw =
        {
        ...
        /// <summary>
        /// Must run after <see cref="Bw1MainPlaythroughRaw"/> / <see cref="Bw2MainPlaythroughRaw"/> — C# initializes static fields in order.
        /// </summary>
        public static HashSet<int> Bw1MainPlaythroughOneBased { get; } = BuildSet(Bw1MainPlaythroughRaw);

        public static HashSet<int> Bw2MainPlaythroughOneBased { get; } = BuildSet(Bw2MainPlaythroughRaw);

        public static bool IsMainPlaythroughTrainer(bool bw2, int trainerOneBasedIndex)
        {
            var set = bw2 ? Bw2MainPlaythroughOneBased : Bw1MainPlaythroughOneBased;
            return set.Contains(trainerOneBasedIndex);
        }
    }
}
